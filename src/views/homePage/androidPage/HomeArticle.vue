      ...
      <div class="list-header">
        ...
        <ul class="nav-list">
          ...
          <li class="nav-recommend" @click="hideSelect">
            <router-link active-class="active" to="/androidPage/recommend"
              >推荐</router-link
            >
          </li>
          <!-- 最新 -->
          <li class="nav-newest" @click="hideSelect">
            <router-link active-class="active" to="/androidPage/newest"
              >最新</router-link
            >
          </li>
          <!-- 热榜 -->
          <li class="nav-hots" @click="displaySelect">
            <router-link active-class="active" to="/androidPage/hots"
              >热榜</router-link
            >
          </li>
          <!-- 下拉框 -->
